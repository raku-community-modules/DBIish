...
my %ref = (name => ['BUBH', 'TAFM', 'BEOM'], 
           ...
           quantity => [1, 1, 2], 
           price => [4.95, 4.85, 1.20],
           amount => [4.95, 4.85, 2.40]);
...
@ref = ({name => 'BUBH', description => 'Hot beef burrito', quantity => 1, price => 4.95, amount => 4.95},
           {name => 'TAFM', description => 'Mild fish taco', quantity => 1, price => 4.85, amount => 4.85},
           {name => 'BEOM', description => 'Medium size orange juice', quantity => 2, price => 1.20, amount => 2.40}
           );
todo "Figure what is wrong with is-deeply";
